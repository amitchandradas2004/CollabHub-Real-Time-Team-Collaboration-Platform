  ...
  useEffect(() => {
    ...
    async function fetchProjectData() {
      try {
        ...
        console.error("Admin project details fetch error:", err);
      } finally {
        setLoading(false);
      }
    }
    ...
    return (
      <DashboardLayout allowedRoles={["admin"]}>
        <div className="glass-panel rounded-3xl p-12 text-center space-y-4">
          ...
          <Button href="/dashboard/admin/projects" variant="primary" size="sm">
  ...
  return (
    <DashboardLayout allowedRoles={["admin"]}>
      <div className="space-y-6">
        <Button href="/dashboard/admin/projects" variant="outline" size="sm" leftIcon={<ArrowLeft className="w-4 h-4" />}>
          Back to Projects List
        </Button>

        {/* Project Header Banner */}
        <div className="glass-panel rounded-3xl p-6 sm:p-8 border border-slate-200/80 dark:border-slate-800 shadow-xl space-y-4 bg-gradient-to-r from-purple-600/10 via-indigo-600/10 to-blue-600/10">
